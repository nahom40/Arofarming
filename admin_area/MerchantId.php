...
if (isset($_POST['insert_brand'])) {
    ...
    $select_query = "SELECT * FROM `merchant_ids` WHERE `Merchant_Id`='$supplier_title' and `A_id`='$thedata' ";
    ...
    if (!$result_select) {
        ...
        if ($number > 0) {
            ...
            $insert_query = "INSERT INTO `merchant_ids`( `A_id`,`Merchant_Id`) VALUES ('$thedata', '$supplier_title')";
