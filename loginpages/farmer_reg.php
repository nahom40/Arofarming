...
<div class="wrapper">
        ...
        <form class="p-3 mt-3" method="post" enctype="multipart/form-data" action="account.php" >
            ...
            <div class="form-field d-flex align-items-center">
                <span class="far fa-user"></span>
                <input type="text" name="subcity" id="subcity" placeholder="subcity">
            </div>
            ...
            <button class="btn mt-3" name="insert_farmer">register</button>
        </form>
        <div class="text-center fs-6">
            <a href="#">Forget password?</a> or <a href="farmer.php">log in </a>
        </div>
    </div>                                 
